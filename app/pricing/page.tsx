...
const plans = [
  ...
  },
  {
    ...
    features: ["1,000 appointments/month", "Waitlist fill logic", "Team dashboard", "Priority support"],
    highlighted: true,
  ...
  },
  {
    ...
    features: ["Unlimited appointments", "Advanced analytics", "Calendar integrations", "Dedicated onboarding"],

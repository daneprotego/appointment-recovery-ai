...
const outlineButton =
  "inline-flex items-center justify-center rounded-full border border-slate-300 bg-white px-6 py-3 text-center text-sm font-bold text-slate-950 shadow-sm transition hover:border-blue-300 hover:bg-blue-50 hover:text-blue-700";

const smallOutlineButton =
  "inline-flex items-center justify-center rounded-full border border-slate-300 bg-white px-5 py-2.5 text-sm font-bold text-slate-950 shadow-sm transition hover:border-blue-300 hover:bg-blue-50 hover:text-blue-700";
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-slate-50 text-slate-950">
      <header className="mx-auto flex max-w-7xl items-center justify-between px-6 py-6 lg:px-8">
        ...
        <Link href="/dashboard" className={smallOutlineButton}>
          Open dashboard
        </Link>
      </header>
      ...
      <section className="relative mx-auto grid max-w-7xl gap-12 px-6 py-16 lg:grid-cols-[1fr_0.9fr] lg:px-8 lg:py-24">
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-600">
            Appointment Recovery AI helps clinics, salons, studios, and service
            teams reduce no-shows with automated reminders, AI message triage,
            rescheduling prompts, and waitlist fill workflows.
          </p>
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            ...
            <Link href="/signup" className={outlineButton}>
              Start free
            </Link>
          ...
          <div className="rounded-[1.5rem] border border-slate-200 bg-slate-950 p-5 text-white">
            ...
            <div className="space-y-3">
              {features.map((feature) => (
                <div
                  key={feature}
                  className="flex items-center gap-3 rounded-2xl bg-white p-3 text-slate-900"
                >
      ...
      <section id="features" className="mx-auto max-w-7xl px-6 pb-20 lg:px-8">
        <div className="grid gap-6 md:grid-cols-3">
          {[
            ...
            [
              "Classify",
              "Use AI to route customer replies into confirm, cancel, and reschedule queues.",
            ],
            [
              "Recover",
              "Fill newly opened slots with waitlisted customers before revenue is lost.",
            ],
